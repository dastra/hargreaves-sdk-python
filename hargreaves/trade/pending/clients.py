...
from hargreaves.trade.pending.errors import CancelPendingOrderError
from hargreaves.trade.pending.models import PendingOrder
from hargreaves.trade.pending.parsers import parse_pending_orders
...
class PendingOrdersClient:
    ...
    def get_pending_orders(self, account_id: int) -> List[PendingOrder]:
        ...
        self._logger.debug(f"Get pending order for account '{account_id}' ...")
    ...
    def cancel_pending_order(self, cancel_order_id: int, pending_orders: List[PendingOrder]) -> bool:
        ...
        self._logger.debug(f"Cancel Pending Order '{cancel_order_id}' ...")
